...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      value: '',
      channel: ['au-top-layout-bw', 'au-top-layout-color', 'architecture-drawings-and-speculations', 'au-top-poster', 'posters-1495721171', 'poster-design-1497727531', 'book-design--3'],
      url: '',
      channelName: '',
      chConnections: [],
      channelInfo: {},
